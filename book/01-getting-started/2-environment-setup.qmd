...
2. **Start Tercen Studio:**
```bash
# optional: enables installing operators from private GitHub repositories
# (classic PAT with `repo` scope — fine-grained tokens are not accepted)
...
See the **Tercen Studio appendix** for the full details: architecture, updating
pinned versions, the optional RStudio profile and why expected test output
should be generated in the operator's own image rather than in RStudio, and
upgrading from a pre-2026-08 studio.
