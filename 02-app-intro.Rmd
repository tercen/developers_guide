...
An operator app performs a simple specific computational function, examples:
...
An operator app is written using a variety of programming languages (R, Python, Rust). The code is put on git hub for the app library to find. 
