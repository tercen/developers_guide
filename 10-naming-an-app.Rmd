...
Here are the guidelines for naming an operator (i.e. a github repo)

The recommended structure of an operator name is:
...
Please make sure the git repo description outline the a brief functional description of the operator.
